<h2> Hi, I'm Stephan! <img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"></h2>
...
const ME = {
 ...
 currentChallenge: "Leetcode Mediums, Building Redis from scratch."
}
```
